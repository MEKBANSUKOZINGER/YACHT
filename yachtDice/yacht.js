...
var fourOfKindAudio = new Audio('./voice/fourOfKindVoice.mp3');
var fullHouseAudio = new Audio('./voice/fullHouseVoice.mp3');
var smallStrAudio = new Audio('./voice/smallStrVoice.mp3');
var largeStrAudio = new Audio('./voice/largeStrVoice.mp3');
var yachtAudio = new Audio('./voice/yachtVoice.mp3');
var chooseAudio = new Audio('./voice/chooseVoice.mp3');
...
function judge(array) {
    ...
    const smallStrEx_12 = [3,3,4,5,6];
    const smallStrEx_13 = [3,4,4,5,6];
    const smallStrEx_14 = [3,4,5,5,6];
    const smallStrEx_15 = [3,4,5,6,6];
    ...
    if (result.one == 5 || result.two == 5 || result.three == 5 || result.four == 5 || result.five == 5 || result.six == 5) {
        console.log("yacht");
        yachtScore = 50;
        logo.src = "./logoImages/yachtLogo.png";
        yachtAudio.play();
        ...
        logo.src = "./logoImages/fourOfKindLogo.png";
        fourOfKindAudio.play();
        ...
        smallStrScore = 15;
        logo.src = "./logoImages/smallStrLogo.png";
        smallStrAudio.play();
        ...
        logo.src = "./logoImages/smallStrLogo.png";
        smallStrAudio.play();
    } else if (stringArr == JSON.stringify(smallStrEx_12) || stringArr == JSON.stringify(smallStrEx_13) || stringArr == JSON.stringify(smallStrEx_14) || stringArr == JSON.stringify(smallStrEx_15)) {
        console.log("small straight");
        smallStrScore = 15;
        logo.src = "./logoImages/smallStrLogo.png";
        smallStrAudio.play();
...
function turnChange() {
    ...
    bonusP2.innerText = `P2 : ${acesP2RealScore + ducesP2RealScore + threesP2RealScore + foursP2RealScore + fivesP2RealScore + sixesP2RealScore} / 63`;
    if (totalBonusP1 >= 63) {
    ...
    var totalP1Score = acesP1RealScore + ducesP1RealScore + threesP1RealScore + foursP1RealScore + fivesP1RealScore + sixesP1RealScore + choiceP1RealScore + fourOfKindP1RealScore + fullHouseP1RealScore + smallStrP1RealScore + largeStrP1RealScore + yachtP1RealScore + bonusP1RealScore;
    var totalP2Score = acesP2RealScore + ducesP2RealScore + threesP2RealScore + foursP2RealScore + fivesP2RealScore + sixesP2RealScore + choiceP2RealScore + fourOfKindP2RealScore + fullHouseP2RealScore + smallStrP2RealScore + largeStrP2RealScore + yachtP2RealScore + bonusP2RealScore;
    totalP1.innerText = totalP1Score;
    totalP2.innerText = totalP2Score;
    turn += 1;
    rollCount = 3;
    alert("turn change");
    if (turn % 2 == 1) {
    ...
    if (turn == 25) {
        ...
        if (totalP1Score > totalP2Score) {
            location.href = "./P1win.html";
        } else if (totalP1Score < totalP2Score) {
            location.href = "./P2win.html";
        } else {
